...
**Definition:**
    A **geometric simplex** $ \Delta $ is the convex hull of a set of affinely independent points in a Euclidean space.
...
The union of two simplicial complex is just their set-theoretic union and we are always assuming that simplicial complexes are disjoint sets.
